...
<body>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <ul>
                            <li class="menu-item">
                                ...
                                <div class="submenu-full">
                                    ...
                                    <a href="../entrar.html"><i class="fa-solid fa-right-from-bracket"></i> Trocar
                                        Conta</a>
                ...
                <div class="col-md-6 text-center">
                    <h2 style="color: white;font-size: 60px;">VÍDEO AULAS</h1>
                </div>
            </div>
        </div>
    </header>
        ...
        <div id="video" class="container">
            ...
            <div class="row justify-content-center">
                <div class="player d-flex flex-column align-items-start" style="width: fit-content;">
                    ...
                    <h2>Aula - 1</h2>
                    <video src="#" controls width="800" style="border-radius: 15px;"></video>
                    <div class="button-concluido">
                        <button id="confirmarAssistido" class="btn btn-secondary" style="margin-top: 10px;">
                            Nao completo
                        </button>
                    </div>
                </div>
                <div class="button-video">
                    ...
                    <div class="background-btn-aulas">
                        <div class="row">
                            <div class="ebook-list-container col-md-2">
                                <button id="toggleEbookList" class="btn btn-primary mb-2 button-ebook">
                                    <a href="ebook.html" style="text-decoration: none; color: white;">E-book</a>
                                </button>
                            </div>
                            <div class="col-md-7">
                                <p>Clique aqui para acessar o E-BOOK deste curso.</p>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <p>Clique aqui para acessar mais aulas deste curso.</p>
                            </div>
                            <div class="col-md-3">
                                ...
                                <li class="video-item d-flex align-items-start gap-3 mb-4" data-src="video1.mp4"
                                    ...
                                    <div class="descricao-aulas">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary acessar-aula-btn mt-2"
                                            style="color: white; border-color: white;"><a
                                                style="text-decoration: none; color: white;"
                                                href="videoaula.html">Acessar Aula</a></button>
                                    </div>
                                </li>
    ...
    <script>
        ...
        if (btnConfirmar) {
            btnConfirmar.addEventListener('click', () => {
                videosAssistidos[currentVideoSrc] = !videosAssistidos[currentVideoSrc]; // Alterna status
                updateConfirmButton();
