...
<body>
    ...
    <script>
        ...
        function mostrarBotaoCertificado() {
            ...
            if (!btn) {
                ...
                btn.addEventListener('click', () => {
                    ...
                    window.open(`../../api/professor/gerar_certificado.php?curso_id=<?php echo $curso_id; ?>`, '_blank');
        ...
        fetch('../../api/professor/buscar_progresso.php', { credentials: 'include' })
            .then(res => res.json())
            .then(data => {
        ...
        btnConcluido.addEventListener('click', () => {
            ...
            fetch('../../api/professor/marcar_assistido.php', {
                method: 'POST',
